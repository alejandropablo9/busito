...
public class LoginInteractor{
    ...
    public void login(GoogleSignInAccount signInAccount, final Callback callback){
        signInGoogle(signInAccount, callback);
    }
    ...
    private  void signInGoogle(GoogleSignInAccount signInAccount, final  Callback callback){
